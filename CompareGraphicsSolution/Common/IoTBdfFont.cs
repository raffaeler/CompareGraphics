...
/*
 Copied from https://github.com/dotnet/iot/blob/main/src/devices/Common/Iot/Device/Graphics/BdfFont.cs
*/
namespace Common
{
    /// <summary>
    ...
    public class IoTBdfFont
    {
        ...
        public static IoTBdfFont Load(string fontFilePath)
        {
            using StreamReader sr = new StreamReader(fontFilePath);
            IoTBdfFont font = new IoTBdfFont();
